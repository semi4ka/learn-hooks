...
import withSimpleEx from "../examples/hoc/withSimpleEx";
import CardWrapper from "../common/Card";
import withPropsStyles from "../examples/hoc/withPropsStyles";
import SmallTitle from "../common/typografy/smallTitle";

const HocExercise = () => {
  const ComponentWidthSimple = withSimpleEx(SimpleComponent);
  const ExComponent = withPropsStyles(ComponentWidthSimple);
  return (
    <>
